...
export default function PluginsPage() {
  ...
  return (
    ...
    <div className="flex-1 bg-gradient-to-br from-gray-900 via-slate-900 to-orange-900/20 pt-20">
      {selectedFile ? (
        <div className="p-8 h-full">
          <div className="mb-8">
           <h2 className="text-3xl font-bold bg-gradient-to-r from-yellow-300 to-orange-400 bg-clip-text text-transparent mb-3">
              {selectedFile.name}
            </h2>
