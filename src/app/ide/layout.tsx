          ...
          <Sidebar open={isSidebarOpen} setOpen={setIsSidebarOpen}>
            <SidebarBody className="justify-between gap-10">
              <div className="flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
                {isSidebarOpen ? 'COREbuilder' : <LogoIcon />}
              ...
              <div className="flex flex-col gap-4">
                {!address ? (
                  <button
                   ...
                   className="flex items-center gap-2 rounded-lg px-3 py-2 text-neutral-200 bg-orange-600 hover:bg-orange-700 transition-colors"
                  >
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <div className="relative bg-gray-900/95 border border-gray-700/50 rounded-2xl p-8 w-full max-w-md backdrop-blur-xl">
             ...
             <div className="absolute inset-0 bg-gradient-to-br from-orange-900/10 to-transparent rounded-2xl"></div>
              ...
              <div className="relative">
                ...
                <button
                 ...
                 className="group relative w-full py-4 px-6 bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-500 hover:to-yellow-500 rounded-xl text-white font-semibold transition-all duration-200 flex items-center justify-center space-x-3 shadow-xl hover:shadow-orange-500/25 hover:scale-105"
                >
                 <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-yellow-600 rounded-xl blur opacity-30 group-hover:opacity-50 transition-opacity"></div>
