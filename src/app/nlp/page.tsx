    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all font-mono text-sm"
        />
    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        <textarea
          ...
          rows={4}
         className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all resize-none font-mono text-sm"
        />
              ...
              if (functions.length > 0) {
                return (
                  <div className="p-4 bg-gradient-to-br from-gray-900 to-black rounded-lg border border-gray-800">
                   <h4 className="text-xs font-medium text-orange-400 mb-3">Available Functions</h4>
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    <textarea
                      ...
                      rows={4}
                     className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                    />
                  </div>
                  <button
                    onClick={handleProcess}
                    disabled={isProcessing || !input.trim()}
                   className="px-6 py-3 bg-gradient-to-r from-orange-600 to-yellow-600 text-white rounded-lg hover:from-orange-700 hover:to-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 font-medium shadow-lg shadow-orange-600/25 transition-all duration-200"
                  >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-6 bg-gradient-to-br from-gray-900 to-black rounded-xl border border-gray-800">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="font-semibold text-orange-400 flex items-center space-x-3">
                      ...
                      <div className="p-4 bg-black rounded-lg border border-gray-800">
                        <code className="text-orange-300 font-mono text-sm break-all">
                          {result.functionCall}
                        </code>
                      </div>
                    </div>
                    ...
                    {result.parameters && (
                      <div className="p-6 bg-gradient-to-br from-gray-900 to-black rounded-xl border border-gray-800">
                      <h4 className="font-semibold text-orange-400 mb-4 flex items-center space-x-2">
                          <Settings className="w-4 h-4" />
                        ...
                        <div className="space-y-3">
                          {result.parameters.map((param, idx) => (
                            ...
                            >
                             ...
                             <code className="text-orange-300 font-mono text-sm bg-gray-900 px-3 py-1 rounded">
                                {param.value}
                              </code>
                            </div>
                          ))}
                    ...
                    <div className="flex justify-center pt-4">
                      <button
                       ...
                       className="px-8 py-4 bg-gradient-to-r from-orange-600 to-yellow-600 text-white rounded-xl hover:from-orange-700 hover:to-yellow-700 flex items-center space-x-3 font-semibold shadow-lg shadow-orange-600/25 transition-all duration-200"
                      >
          ...
          <div className="p-6 border-b border-gray-800">
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {history.map((item) => (
                <div
                  key={item.id}
                  className="p-4 bg-black rounded-lg border border-gray-800 cursor-pointer hover:border-orange-500/30 hover:bg-gray-900/50 transition-all duration-200"
          ...
          <div className="p-6 flex-1">
            ...
            <div className="space-y-3">
              {savedCommands.map((saved) => (
                <div
                  key={saved.id}
                  className="p-3 bg-black rounded-lg border border-gray-800 cursor-pointer hover:border-orange-500/30 hover:bg-gray-900/50 transition-all duration-200"
