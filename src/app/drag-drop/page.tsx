      ...
      lines.forEach((line) => {
        ...
        if ((match = line.match(patterns.stateVariable))) {
          ...
          component = {
            ...
            color: "bg-orange-100 border-yellow-300",
            x: 50,
            y: currentY,
            properties: {
              name: match[1],
  ...
  return (
    <div className="min-h-screen bg-black flex overflow-hidden">
      ...
      <div className="w-80 bg-black/90 backdrop-blur-xl border-r border-gray-800/50 flex flex-col h-screen pt-25">
        ...
        <div className="bg-gradient-to-r from-orange-400/20 to-yellow-400/20 backdrop-blur-sm rounded-xl p-4 border border-orange-400/30">
          ...
          <div className="p-4 space-y-3">
            {filteredComponents.map((component) => (
              <div
               ...
               className="group p-4 rounded-xl bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 cursor-move hover:bg-gray-800/50 hover:border-orange-400/30 transition-all duration-300 transform hover:scale-105"
              >
                <div className="flex items-center space-x-3">
                 <div className="text-orange-400 group-hover:text-orange-300 transition-colors">{component.icon}</div>
                  <div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-3">
              <button
               ...
               className="px-6 py-3 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-xl hover:from-orange-600 hover:to-yellow-600 transition-all duration-300 shadow-lg hover:shadow-orange-500/25 font-medium backdrop-blur-sm border border-orange-400/30"
              >
                Generate Code
              </button>
              <button
            ...
            {canvasComponents.map((component) => (
              <div
                ...
                className={`absolute p-4 rounded-xl backdrop-blur-sm border cursor-pointer transition-all duration-300 hover:scale-105 ${selectedComponent?.id === component.id
                  ? "ring-2 ring-orange-400/50 bg-gray-800/80 border-orange-400/50 shadow-lg shadow-orange-400/25"
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-3">
                    <span className="text-orange-400 text-xl">{component.icon}</span>
                    <div>
                      <div className="font-semibold text-sm text-white">{component.name}</div>
              ...
              <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                <div className="text-center">
                  ...
                  <div className="text-sm mt-6 bg-gray-900/80 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 max-w-md">
                    <div className="font-medium mb-3 text-orange-400">Quick Start:</div>
    ...
    <div className="p-6 border-b border-gray-800/50">
      <div className="flex items-center justify-between">
        <h3 className="font-bold text-lg flex items-center space-x-3 text-white">
          <span className="text-orange-400">{selectedComponent.icon}</span>
          ...
          <div key={key}>
            ...
            {key === "visibility" ? (
              <select
                ...
                className="w-full p-3 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-lg focus:ring-2 focus:ring-orange-400/50 focus:border-orange-400/50 transition-all text-white"
              >
      ...
      <option key={type} value={type}>{type}</option>
              ...
              <div className="space-y-3">
                <textarea
                  value={String(value || '')}
                  onChange={(e) => updateComponentProperty(selectedComponent.id, key, e.target.value)}
                className="w-full p-3 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-lg focus:ring-2 focus:ring-orange-400/50 focus:border-orange-400/50 transition-all text-white placeholder-gray-500 font-mono text-sm"
                  ...
                  {showAiInput && (
                    <div className="space-y-3">
                      <textarea
                        ...
                        className="w-full p-3 bg-gray-800/50 backdrop-blur-sm border border-gray-600/50 rounded-lg focus:ring-2 focus:ring-orange-400/50 focus:border-orange-400/50 transition-all text-white placeholder-gray-400 text-sm"
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-lg hover:from-orange-600 hover:to-yellow-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium"
                      >
        ...
        <div className="mt-6 p-4 bg-orange-400/10 backdrop-blur-sm rounded-lg border border-orange-400/20">
              ...
              <div className="flex justify-between items-center p-6 border-b border-gray-700/50">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="px-4 py-2 bg-orange-500/80 backdrop-blur-sm text-white rounded-lg hover:bg-orange-600/80 transition-all font-medium border border-orange-400/30 flex items-center gap-2"
                  >
            ...
            <div className="bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-700/50 w-full max-w-2xl">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    onClick={() => setIsImportModalOpen(false)}
                    className="px-4 py-2 bg-orange-500/80 backdrop-blur-sm text-white rounded-lg hover:bg-orange-600/80 transition-all border border-orange-400/30"
                  >
                    Import
                  </button>
                </div>
