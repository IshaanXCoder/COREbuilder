...
module.exports = {
  ...
  networks: {
    ...
    coreTestnet: {
      url: process.env.CORE_RPC_TESTNET || 'https://rpc.test.btcs.network',
      accounts: process.env.PRIVATE_KEY ? [process.env.PRIVATE_KEY] : [],
      chainId: 1114,
    },
    localhost: {
  ...
  etherscan: {
    apiKey: process.env.CORE_SCAN_API_KEY,
  },
};`
        },
        {
          name: 'package.json',
          content: `{
  "name": "hardhat-core-project",
  "version": "1.0.0",
  "description": "A professional Hardhat project for Core ecosystem",
  "main": "index.js",
  "scripts": {
    ...
    "deploy:testnet": "npx hardhat ignition deploy ./ignition/modules/Deploy.js --network coreTestnet",
    "verify": "npx hardhat verify --network coreTestnet",
    "node": "npx hardhat node",
    "clean": "npx hardhat clean"
  },
  "keywords": ["hardhat", "core", "ethereum", "solidity"],
  "author": "Your Name",
  "license": "MIT",
  "devDependencies": {
...
COINMARKETCAP_API_KEY=your_coinmarketcap_api_key_here`
        ...
        {
          name: 'README.md',
          content: `# Hardhat Core Project

This project demonstrates a basic Hardhat setup for Core ecosystem development.
...
- \`npm run deploy:testnet\` - Deploy to Core testnet
...
Never commit your \`.env\` file or expose your private keys!`
      ...
      // Download as ZIP
      await createZipAndDownload(files, 'hardhat-core-template.zip');
...
export const core = defineChain({
  ...
  rpcUrls: {
    default: {
      http: [process.env.CORE_RPC_MAINNET || 'https://rpc.coredao.org'],
    },
    public: {
      http: [process.env.CORE_RPC_MAINNET || 'https://rpc.coredao.org'],
    },
  ...
  blockExplorers: {
    default: { name: 'Core Scan', url: process.env.CORE_EXPLORER_MAINNET || 'https://scan.coredao.org' },
  },
});

const transport = http(core.rpcUrls.default.http[0]);
...
// });`
        },
        {
          name: 'package.json',
          content: `{
  "name": "viem-core-project",
  "version": "1.0.0",
  "description": "A professional Viem project for Core ecosystem",
  "main": "index.js",
  "type": "module",
  "scripts": {
    "build": "tsc",
  ...
  "keywords": ["viem", "core", "ethereum", "web3"],
  "author": "Your Name",
  "license": "MIT",
  "dependencies": {
    "viem": "^2.0.0"
  ...
  "devDependencies": {
    ...
    "vitest": "^1.0.0"
      ...
      await createZipAndDownload(files, 'viem-core-template.zip');
