...
export const WobbleCard = ({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "mx-auto w-full bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900 relative rounded-xl overflow-hidden border border-slate-800/50",
        containerClassName
      )}
    >
      <div
        className="relative h-full [background-image:radial-gradient(circle_at_top_right,rgba(251,146,60,0.15),rgba(245,101,41,0.1),transparent_50%)] sm:mx-0 sm:rounded-xl overflow-hidden"
        style={{
          boxShadow:
...
const ProfessionalOverlay = () => {
  return (
    <>
      ...
      {/* Bottom left accent */}
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-orange-600/8 to-transparent rounded-tr-full" />
    </>
  );
};