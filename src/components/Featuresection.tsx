  ...
  const features = [
    {
      ...
      description:
        "Build and deploy secure smart contracts on Core's high-performance blockchain with our advanced IDE, real-time debugging, and optimization tools.",
    ...
    },
    {
      ...
      description:
        "Generate blockchain code effortlessly with our intelligent AI that understands Solidity patterns and Core's EVM architecture.",
    ...
    },
    {
      ...
      description:
        "Master Core development with our comprehensive tutorials and community-driven learning resources.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r border-neutral-800",
    },
    {
      title: "Deploy to Core Network",
      description:
        "Deploy your smart contracts to Core's EVM-compatible blockchain with one-click deployment to mainnet, testnet, or local networks.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-6xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal text-neutral-300">
          From smart contract development to DeFi protocols, COREbuilder AI provides everything you need to build on Core with confidence.
        </p>
      </div>
      ...
      <div className="w-full max-w-sm mx-auto bg-neutral-900 rounded-lg overflow-hidden shadow-2xl">
        ...
        <div className="p-4">
          <h4 className="text-white font-semibold text-sm mb-1">
            Core Development Masterclass
          </h4>
          <p className="text-neutral-400 text-xs">
            Learn Core smart contract development from experts
          </p>
        </div>
      </div>
    ...
    <div className="h-48 flex flex-col items-center justify-center relative bg-transparent">
      <div className="text-center mb-6">
        ...
        <p className="text-neutral-400 text-sm">
          Deploy to Core networks worldwide
        </p>
      </div>
